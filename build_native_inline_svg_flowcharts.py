...
print("1. Generating 100% native inline SVG diagrams inside all 20 FLOWCHART.html files...")
for p in projects_data:
    html_content = build_native_html(p)
    html_path = os.path.join(base_dir, p["dir"], "FLOWCHART.html")
    with open(html_path, "w") as f:
        f.write(html_content)
    print(f"Embedded native inline SVG in {p['dir']}/FLOWCHART.html")
...
print("Successfully updated all 20 FLOWCHART.html files with 100% native inline SVG diagrams!")
