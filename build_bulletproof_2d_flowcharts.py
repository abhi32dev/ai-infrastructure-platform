...
def build_native_html(p):
    inline_svg_markup = build_inline_svg(p)
...
<head>
    ...
    <style>
        ...
        * {{
        ...
        .flow-arrow-v.rose {{ color: var(--accent-rose); }}
...
print("1. Generating bulletproof HTML pages with 100% native HTML/CSS and inline SVGs...")
for p in projects_data:
    html_content = build_native_html(p)
    html_path = os.path.join(base_dir, p["dir"], "FLOWCHART.html")
    with open(html_path, "w") as f:
        f.write(html_content)
    print(f"Generated bulletproof FLOWCHART.html: {p['dir']}")

print("2. Copying updated FLOWCHART.html files to 5 secondary alias directories...")
alias_mappings = [
...
for src_dir, target_dir in alias_mappings:
    ...
    print(f"Copied HTML from {src_dir} to {target_dir}")

print("Successfully rebuilt all FLOWCHART.html files with zero image dependencies!")
